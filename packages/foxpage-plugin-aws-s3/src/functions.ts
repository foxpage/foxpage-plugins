 ...
 * @returns Promise
 */
export const getObjectContent = async (client: S3Client, bucket: string, objectName: string): Promise<any> => {
 ...
 * @returns Promise
 */
export const listFolderObjects = async (client: S3Client, bucket: string, prefix: string): Promise<string[]> => {
  let files: string[] = [];
...
export const objectList = async (
  ...
  const objectList: StorageListRes[] = [];
