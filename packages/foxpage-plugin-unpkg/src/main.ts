...
import { formatResponse, getPackageFoxpage, getPackageManifest, searchNpmPackage, UnpkgManifest } from './functions';
  ...
  return {
    ...
    visitor: {
      resourceList: async (options: ResourceListOptions): Promise<IndexContent> => {
        ...
        const groupResources: IndexContent = { type: PLUGIN_NAME, group: '', packages: [] };
